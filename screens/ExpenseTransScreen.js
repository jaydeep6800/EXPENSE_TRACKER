...
import { subAccountPrice } from '../redux/actions/Account';

import RNPickerSelect from 'react-native-picker-select';

import DateTimePicker from '@react-native-community/datetimepicker';

const ExpenseTransScreen = props => {
...
const mapStateToProps = state => {
  return {
    ...
    category: state.CategoryReducer.ExpensecategoryList
  };
};

const mapDispatchToProps = dispatch => {
  return {
    addExpense: obj => dispatch(addTrans(obj)),
    subPrice: (id, price) =>
